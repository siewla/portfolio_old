...
const NavBar = (props) => {
  ...
  return (
    <MDBNavbar color='darkblue' dark expand='md' scrolling fixed='top'>
      <MDBNavbarBrand>
        <DarkModeToggle
          checked={props.theme}
      ...
      <MDBCollapse id='navbarCollapse3' isOpen={isOpen} navbar>
        ...
        <MDBNavbarNav right>
          ...
          <a href='https://github.com/siewla' target='popup'>
            <i className='fab fa-github contact-icon'></i>
          </a>
          <a href='https://www.linkedin.com/in/siewlapang/' target='popup'>

    ...
    <div className='about'>
      ...
      <div className='flex-column-center'>
        <div className='about-description'>
          ...
          <p>
            I graduated with BSc and MSc in Mechanical Engineering and have been
            working as a Mechanical Design Engineer for 7 years.
          </p>
          <p>
            I am a Malaysian and also a Singapore Permanent Resident. I resided
            in Malaysia 🇲🇾, USA 🇺🇸 and New Zealand 🇳🇿 previously and currently
        ...
        <a
          href='https://github.com/siewla/portfolio/blob/master/public/resume.pdf'
          target='_blank'
